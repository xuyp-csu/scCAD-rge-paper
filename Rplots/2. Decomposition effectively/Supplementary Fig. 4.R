...
df = read_excel(paste0(workdir, "Supplementary Fig. 4_source_data.xlsx"))
df = as.data.frame(df)
...
ggsave(path = workdir, filename = "Supplementary Fig. 4.png", width = 10, height = 6, device='png', dpi=300)
