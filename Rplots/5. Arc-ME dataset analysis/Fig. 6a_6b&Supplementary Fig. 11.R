...
EDGE_res = read.table(paste0(workdir, "Supplementary Fig. 11_source_data1_EDGE_res.txt"))[,1]
temp_tsne_out = tsne_out
...
ggsave(path = workdir, filename = "Supplementary Fig. 11_EDGE_res.png",width = 8, height = 6, device='png', dpi=300)

##################### FiRE ###########################

FiRE_res = read.table(paste0(workdir, "Supplementary Fig. 11_source_data2_FiRE_res.txt"))[,1]
temp_tsne_out = tsne_out
...
ggplot(temp_tsne_out, aes(x=tSNE_1, y=tSNE_2, color=label)) + 
  ...
  theme(text=element_text(size=15,  family="serif",face = 'bold'),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  guides(color = guide_legend(override.aes = list(size = 4)))
ggsave(path = workdir, filename = "Supplementary Fig. 11_FiRE_res.png",width = 8, height = 6, device='png', dpi=300)

##################### GapClust ###########################

GapClust_res = read.table(paste0(workdir, "Supplementary Fig. 11_source_data3_GapClust_res.txt"))[,1]
temp_tsne_out = tsne_out
...
ggplot(temp_tsne_out, aes(x=tSNE_1, y=tSNE_2, color=label)) + 
  ...
  theme(text=element_text(size=15,  family="serif",face = 'bold'),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  guides(color = guide_legend(override.aes = list(size = 4)))
ggsave(path = workdir, filename = "Supplementary Fig. 11_GapClust_res.png",width = 8, height = 6, device='png', dpi=300)

##################### SCA ###########################

SCA_res = read.table(paste0(workdir, "Supplementary Fig. 11_source_data4_SCA_res.txt"))[,1]
temp_tsne_out = tsne_out
...
ggplot(temp_tsne_out, aes(x=tSNE_1, y=tSNE_2, color=label)) + 
  ...
  theme(text=element_text(size=15,  family="serif",face = 'bold'),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  guides(color = guide_legend(override.aes = list(size = 4)))
ggsave(path = workdir, filename = "Supplementary Fig. 11_SCA_res.png",width = 8, height = 6, device='png', dpi=300)
