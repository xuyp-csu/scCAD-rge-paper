...
load(paste0(workdir, "Supplementary Fig. 15a_source_data1_PBMC-bench-2_tsne.Rdata"))
...
ggsave(path = workdir, filename = "Supplementary Fig. 15a.png",width = 8, height = 6, device='png', dpi=300)
