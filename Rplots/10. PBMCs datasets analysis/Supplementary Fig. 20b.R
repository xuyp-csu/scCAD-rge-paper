...
load(paste0(workdir, "Supplementary Fig. 18b_source_data1_PBMC-test_umap.Rdata"))
...
ggsave(path = workdir, filename = "Supplementary Fig. 18b.png",width = 12, height = 6, device='png', dpi=300)
