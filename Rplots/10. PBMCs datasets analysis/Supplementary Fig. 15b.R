...
load(paste0(workdir, "Supplementary Fig. 15b_source_data1_PBMC-bench-2_umap.Rdata"))
...
ggsave(path = workdir, filename = "Supplementary Fig. 15b.png",width = 8, height = 6, device='png', dpi=300)
