...
load(paste0(workdir, "Supplementary Fig. 18a_source_data1_PBMC-test_tsne.Rdata"))
...
ggsave(path = workdir, filename = "Supplementary Fig. 18a.png",width = 12, height = 6, device='png', dpi=300)
