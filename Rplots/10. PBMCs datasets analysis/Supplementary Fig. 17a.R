...
load(paste0(workdir, "Supplementary Fig. 17a_source_data1_PBMC-bench-3_tsne.Rdata"))
...
ggsave(path = workdir, filename = "Supplementary Fig. 17a.png",width = 8, height = 6, device='png', dpi=300)
