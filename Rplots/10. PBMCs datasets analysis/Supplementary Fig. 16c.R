...
scCAD_res = read.table(paste0(workdir, "Supplementary Fig. 16a_source_data2_PBMC-bench-2_scCAD_res.txt"))[,1]
lab = read.table(paste0(workdir, "Supplementary Fig. 16a_source_data3_PBMC-bench-2_lab.txt"))[,1]
load(paste0(workdir, "Supplementary Fig. 16c_source_data1_PBMC-bench-2_degs.Rdata"))
load(paste0(workdir, "Supplementary Fig. 16c_source_data2_PBMC-bench-2_subdata.Rdata"))
...
png(paste0(workdir, "Supplementary Fig. 16c_R3.png"), width = 8, height = 12, units = 'in', res = 600)
...
load(paste0(workdir, "Supplementary Fig. 16c_source_data3_PBMC-bench-2_subdata.Rdata"))
...
png(paste0(workdir, "Supplementary Fig. 16c_R8.png"), width = 8, height = 12, units = 'in', res = 600)
pheatmap(sub_dat[,idx], border_color = NA, cluster_cols = FALSE, 
         annotation_colors = ann_colors,
         annotation_col = annotation, show_colnames = FALSE, annotation_names_col = TRUE)
dev.off()
...
load(paste0(workdir, "Supplementary Fig. 16c_source_data4_PBMC-bench-2_subdata.Rdata"))
...
png(paste0(workdir, "Supplementary Fig. 16c_R9.png"), width = 8, height = 12, units = 'in', res = 600)
pheatmap(sub_dat[,idx], border_color = NA, cluster_cols = FALSE, 
         annotation_colors = ann_colors,
         annotation_col = annotation, show_colnames = FALSE, annotation_names_col = TRUE)
dev.off()
