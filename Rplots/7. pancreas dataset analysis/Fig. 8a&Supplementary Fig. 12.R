...
EDGE_res = read.table(paste0(workdir, "Supplementary Fig. 12_source_data2_EDGE_res.txt"))[,1]
temp_tsne_out = tsne_out
...
FiRE_res = read.table(paste0(workdir, "Supplementary Fig. 12_source_data3_FiRE_res.txt"))[,1]
temp_tsne_out = tsne_out
...
GapClust_res = read.table(paste0(workdir, "Supplementary Fig. 12_source_data4_GapClust_res.txt"))[,1]
temp_tsne_out = tsne_out
...
GiniClust3_res = read.table(paste0(workdir, "Supplementary Fig. 12_source_data5_GiniClust3_res.txt"))[,1]
temp_tsne_out = tsne_out
...
RaceID3_res = read.table(paste0(workdir, "Supplementary Fig. 12_source_data6_RaceID3_res.txt"))[,1]
temp_tsne_out = tsne_out
...
ggplot(temp_tsne_out, aes(x=tSNE_1, y=tSNE_2, color=label)) + 
  ...
  theme(text=element_text(size=15,  family="serif",face = 'bold'),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  guides(color = guide_legend(ncol =1, override.aes = list(size = 4)))
ggsave(path = workdir, filename = "Supplementary Fig. 12_RaceID3_res.png",width = 8, height = 6, device='png', dpi=300)
...
SCISSORS_res = read.table(paste0(workdir, "Supplementary Fig. 12_source_data8_SCISSORS_res.txt"))[,1]
temp_tsne_out = tsne_out
...
ggplot(temp_tsne_out, aes(x=tSNE_1, y=tSNE_2, color=label)) + 
  ...
  theme(text=element_text(size=15,  family="serif",face = 'bold'),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  guides(color = guide_legend(ncol =1, override.aes = list(size = 4)))
ggsave(path = workdir, filename = "Supplementary Fig. 12_SCISSORS_res.png",width = 8, height = 6, device='png', dpi=300)
