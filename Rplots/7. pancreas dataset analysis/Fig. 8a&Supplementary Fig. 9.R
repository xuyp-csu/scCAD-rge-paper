...
CellSIUS_res = read.table(paste0(workdir, "Supplementary Fig. 9_source_data1_CellSIUS_res.txt"))[,1]
temp_tsne_out = tsne_out
...
ggplot(temp_tsne_out, aes(x=tSNE_1, y=tSNE_2, color=label)) + 
  ...
  theme(text=element_text(size=15,  family="serif",face = 'bold'),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  guides(color = guide_legend(ncol =1, override.aes = list(size = 4)))
ggsave(path = workdir, filename = "Supplementary Fig. 9_CellSIUS_res.png",width = 8, height = 6, device='png', dpi=300)

##################### EDGE ###########################

EDGE_res = read.table(paste0(workdir, "Supplementary Fig. 9_source_data2_EDGE_res.txt"))[,1]
temp_tsne_out = tsne_out
...
ggplot(temp_tsne_out, aes(x=tSNE_1, y=tSNE_2, color=label)) + 
  ...
  theme(text=element_text(size=15,  family="serif",face = 'bold'),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  guides(color = guide_legend(ncol =1, override.aes = list(size = 4)))
ggsave(path = workdir, filename = "Supplementary Fig. 9_EDGE_res.png",width = 8, height = 6, device='png', dpi=300)

##################### FiRE ###########################

FiRE_res = read.table(paste0(workdir, "Supplementary Fig. 9_source_data3_FiRE_res.txt"))[,1]
temp_tsne_out = tsne_out
...
ggplot(temp_tsne_out, aes(x=tSNE_1, y=tSNE_2, color=label)) + 
  ...
  theme(text=element_text(size=15,  family="serif",face = 'bold'),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  guides(color = guide_legend(ncol =1, override.aes = list(size = 4)))
ggsave(path = workdir, filename = "Supplementary Fig. 9_FiRE_res.png",width = 8, height = 6, device='png', dpi=300)

##################### GapClust ###########################

GapClust_res = read.table(paste0(workdir, "Supplementary Fig. 9_source_data4_GapClust_res.txt"))[,1]
temp_tsne_out = tsne_out
...
ggplot(temp_tsne_out, aes(x=tSNE_1, y=tSNE_2, color=label)) + 
  ...
  theme(text=element_text(size=15,  family="serif",face = 'bold'),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  guides(color = guide_legend(ncol =1, override.aes = list(size = 4)))
ggsave(path = workdir, filename = "Supplementary Fig. 9_GapClust_res.png",width = 8, height = 6, device='png', dpi=300)

##################### GiniClust3 ###########################

GiniClust3_res = read.table(paste0(workdir, "Supplementary Fig. 9_source_data5_GiniClust3_res.txt"))[,1]
temp_tsne_out = tsne_out
...
ggplot(temp_tsne_out, aes(x=tSNE_1, y=tSNE_2, color=label)) + 
  ...
  theme(text=element_text(size=15,  family="serif",face = 'bold'),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  guides(color = guide_legend(ncol =1, override.aes = list(size = 4)))
ggsave(path = workdir, filename = "Supplementary Fig. 9_GiniClust3_res.png",width = 8, height = 6, device='png', dpi=300)

##################### RaceID3 ###########################

RaceID3_res = read.table(paste0(workdir, "Supplementary Fig. 9_source_data6_RaceID3_res.txt"))[,1]
temp_tsne_out = tsne_out
...
ggplot(temp_tsne_out, aes(x=tSNE_1, y=tSNE_2, color=label)) + 
  ...
  theme(text=element_text(size=15,  family="serif",face = 'bold'),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  guides(color = guide_legend(ncol =1, override.aes = list(size = 4)))
ggsave(path = workdir, filename = "Supplementary Fig. 9_RaceID3_res.png",width = 8, height = 6, device='png', dpi=300)

##################### SCA ###########################

SCA_res = read.table(paste0(workdir, "Supplementary Fig. 9_source_data7_SCA_res.txt"))[,1]
temp_tsne_out = tsne_out
...
ggplot(temp_tsne_out, aes(x=tSNE_1, y=tSNE_2, color=label)) + 
  ...
  theme(text=element_text(size=15,  family="serif",face = 'bold'),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  guides(color = guide_legend(ncol =1, override.aes = list(size = 4)))
ggsave(path = workdir, filename = "Supplementary Fig. 9_SCA_res.png",width = 8, height = 6, device='png', dpi=300)

##################### SCISSORS ###########################

SCISSORS_res = read.table(paste0(workdir, "Supplementary Fig. 9_source_data8_SCISSORS_res.txt"))[,1]
temp_tsne_out = tsne_out
...
ggplot(temp_tsne_out, aes(x=tSNE_1, y=tSNE_2, color=label)) + 
  ...
  theme(text=element_text(size=15,  family="serif",face = 'bold'),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  guides(color = guide_legend(ncol =1, override.aes = list(size = 4)))
ggsave(path = workdir, filename = "Supplementary Fig. 9_SCISSORS_res.png",width = 8, height = 6, device='png', dpi=300)
