...
load(paste0(workdir,"Fig. 3c_3d_source_data_degs.Rdata"))
...
load(paste0(workdir,"Fig. 3c_source_data_subdata.Rdata"))
...
ggsave(path = workdir, filename = "Fig. 3c.pdf",width = 120, height = 60, units = "mm",
       dpi=300)
