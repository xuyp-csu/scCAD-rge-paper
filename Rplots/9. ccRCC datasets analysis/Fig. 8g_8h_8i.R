...
load(paste0(workdir, "Fig. 8g_8h_8i_source_data1_Kidney_ccRCC_scCAD_degs.Rdata"))
load(paste0(workdir, "Fig. 8g_8h_8i_source_data2_Kidney_ccRCC_subdata.Rdata"))
...
png(paste0(workdir, "Fig. 8g_R4.png"), width = 60, height = 80, units = 'mm', res = 600)
...
load(paste0(workdir, "Fig. 8g_8h_8i_source_data3_Kidney_ccRCC_subdata.Rdata"))
...
png(paste0(workdir, "Fig. 8h_R5.png"), width = 60, height = 80, units = 'mm', res = 600)
pheatmap(sub_dat[,comb], border_color = NA, cluster_cols = FALSE, 
         annotation_colors = ann_colors, fontsize = 5, 
         show_rownames = T,
         annotation_col = annotation, show_colnames = FALSE, annotation_names_col = TRUE,
...
load(paste0(workdir, "Fig. 8g_8h_8i_source_data4_Kidney_ccRCC_subdata.Rdata"))
...
png(paste0(workdir, "Fig. 8i_R7.png"), width = 8, height = 12, units = 'in', res = 600)
pheatmap(sub_dat[,comb], border_color = NA, cluster_cols = FALSE, 
         annotation_colors = ann_colors,
         annotation_col = annotation, show_colnames = FALSE, annotation_names_col = TRUE)
dev.off()

png(paste0(workdir, "Fig. 10c_R7.png"), width = 60, height = 80, units = 'mm', res = 600)
pheatmap(sub_dat[,comb], border_color = NA, cluster_cols = FALSE, 
         annotation_colors = ann_colors, fontsize = 5, 
         show_rownames = T,
         annotation_col = annotation, show_colnames = FALSE, annotation_names_col = TRUE,
