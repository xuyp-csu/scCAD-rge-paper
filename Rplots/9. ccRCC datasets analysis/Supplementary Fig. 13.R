...
load(paste0(workdir, "Supplementary Fig. 13_source_data1_Kidney_ccRCC_subdata.Rdata"))
load(paste0(workdir, "Supplementary Fig. 13_source_data2_Kidney_ccRCC_umap_seurat.Rdata"))
...
ggsave(path = workdir, filename = "Supplementary Fig. 13.png",width = 12, height = 8, device='png', dpi=300)
