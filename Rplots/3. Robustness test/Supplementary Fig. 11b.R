...
load(paste0(workdir, "Supplementary Fig. 11b_source_data.Rdata"))
...
ggsave(path = homedir, filename = "Supplementary Fig. 11b.png",width = 12, height = 6, device='png', dpi=300)
