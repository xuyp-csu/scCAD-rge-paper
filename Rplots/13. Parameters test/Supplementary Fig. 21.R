...
workdir = paste0(homedir, 'Rplots/13. Parameters test/')  

library(paletteer)
library(ggplot2)

load(paste0(workdir, "Supplementary Fig. 21_source_data.Rdata"))
...
ggsave(path = workdir, filename = "Supplementary Fig. 21.png",width = 10, height = 6, device='png', dpi=300)
